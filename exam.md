Темы (предварительные) к экзамену по ФП  2025 для второго курса ПИ.
...
2) ☭ Летучка.
   Демонстрировать умение редуцировать лямбда-выражения в одной из 4х стратегий (CBN, CBV, NO, AO). (Выражение и стратегию выбирает экзаменатор.)
